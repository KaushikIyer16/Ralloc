 ...
 */
@WebServlet(name = "ShowDetailGenerationServlet", urlPatterns = {"/Generate/show/detail"})
public class ShowDetailGenerationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rq = request.getRequestDispatcher("/detailAllotment.jsp");
